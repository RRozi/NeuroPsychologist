class Session:
    ...
    VOICE_ID = "21m00Tcm4TlvDq8ikWAM"  # https://api.elevenlabs.io/v1/voices

    APP_VERSION = '1.2'  # application release version

    VOSK_MODEL = r"C:\Users\PYTHON\PycharmProjects\NeuroPsychologist\vosk_small"  # model folder. vosk_small | vosk_big

    GPT_MODEL = "gpt-4"  # gpt-4 | gpt-3.5-turbo (faster)

    TERMS_TEXT = """
    Пользовательское соглашение для приложения "Нейропсихология":
1. Сбор и хранение информации
При использовании приложения "Нейропсихология" мы можем собирать и хранить следующие данные:
...
Используя приложение "Нейропсихология", вы соглашаетесь с нашими правилами сбора и использования информации.
5. Обратная связь
